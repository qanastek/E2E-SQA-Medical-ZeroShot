...
target_substring1="$SLURM_TMPDIR/SpokenMedicalQA_data/audios_wav_ffmpeg_train_concat"

source_substring2="/local_disk/ether/ylabrak/SpokenMedicalQA/audios_wav_ffmpeg_concat"
target_substring2="$SLURM_TMPDIR/SpokenMedicalQA_data/audios_wav_ffmpeg_concat"

# Loop through all CSV files in the specified directory
for file in $SLURM_TMPDIR/SpokenMedicalQA_data/data-30+/*.csv; do
