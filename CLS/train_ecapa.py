...
class ASR(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        outputs = self.hparams.embedding_model(feats, wav_lens)
...
def dataio_prepare(hparams):
    ...
    valid_data = valid_data.filtered_sorted(sort_key="duration_no_answer")
    ...
    @sb.utils.data_pipeline.takes("wav_no_answer")
