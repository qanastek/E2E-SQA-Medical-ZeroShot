...
# python PredictZeroShot-References-Thread.py --model_name="microsoft/phi-1_5"
...
for corpus in all_corpus:
    ...
    with torch.no_grad():
        ...
        for d in tqdm(dataset):
            ...
            inputs = tokenizer(re.sub("\s+", " ", d[f"wrd"]), return_tensors = "pt")
    ...
    f_out = open(f"./results_zeroshot/results_{short_model_name}_ZeroShot_{corpus}_EN_References.json", 'w')
