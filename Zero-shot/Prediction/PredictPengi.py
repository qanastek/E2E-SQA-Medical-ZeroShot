...
for corpus in all_corpus:
    ...
    f_out = open(f"./results_pengi/results_Pengi_ZeroShot_{corpus}_EN_base.json", 'w')
...
f_out_resume = open(f"./results_pengi/results_Pengi_ZeroShot_Resume_EN_base.json", 'w')
